...
这里会整理我的自制学习资料。欢迎参考和使用这些学习资料，也欢迎一起交流、讨论。
...
- 学习资料仓库： [YOUR_LEARNING_MATERIALS_REPO_URL](L)
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=YOUR_GITHUB_USERNAME&show_icons=true&theme=transparent&hide_border=true&rank_icon=github)
...
```text
Name       : Shanyan
Identity   : BJUT undergraduate student
Role       : Beginner Village NPC
Quest      : Share learning materials and grow with other learners
Buff       : Friendly discussion, patient communication, steady progress
...
- 欢迎交流：课程学习、资料整理、项目实践、学习路线讨论

<div align="center">

![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:A78BFA,50:60A5FA,100:6EE7B7&height=120&section=footer)
